...
{
    public partial class saleElectronic : Form
    {
        public saleElectronic()
        {
            InitializeComponent();
            genarateId();
            supplyerName();
        ...
        private void saleElectronic_Load(object sender, EventArgs e)
        {
            Flush();
            cmdCustomerId.Text = "";
            cmd_product_id.Text = "";
        ...
        void printRepot()
        {
            ...
            if (drs == DialogResult.OK)
            {
                ...
                crReportDocument = new CrystalReport.sale.voucherLoanAccording();
        ...
        {
            txt_due_amount.Text = txt_total_amount.Text;
            label22.Text = txt_total_amount.Text;
        }
